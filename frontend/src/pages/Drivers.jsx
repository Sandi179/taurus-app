...
export default function DriversPage() {
  ...
  const deleteDriver = async (id) => {
    ...
    try {
      ...
      toast.error('Cannot delete driver. They may have related records.');
    }
  };
          ...
          <div className="flex gap8">
            ...
            <button className="export-btn excel" onClick={async () => {
              try {
                ...
                const a = document.createElement('a'); a.href = url; a.download = 'drivers_report.xlsx'; a.click(); URL.revokeObjectURL(url);
            ...
            <button className="export-btn pdf" onClick={async () => {
              try {
                ...
                const a = document.createElement('a'); a.href = url; a.download = 'drivers_report.pdf'; a.click(); URL.revokeObjectURL(url);
                    ...
                    <tr key={d.id}>
                      ...
                      <td>
                        <div className="flex gap4">
                          ...
                          <button className="btn btn-danger btn-xs" onClick={() => deleteDriver(d.id)}>Del</button>
                        </div>
                      </td>
                    </tr>
                  );
