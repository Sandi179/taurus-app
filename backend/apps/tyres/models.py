...
class TyreAssignment(TimeStampedModel):
    ...
    tyre         = models.ForeignKey(Tyre,           on_delete=models.CASCADE, related_name='assignments')
    truck        = models.ForeignKey('trucks.Truck', on_delete=models.CASCADE, related_name='tyre_assignments')
...
class TyreSwap(TimeStampedModel):
    ...
    tyre           = models.ForeignKey(Tyre,           on_delete=models.CASCADE, related_name='swaps')
    from_truck     = models.ForeignKey('trucks.Truck', on_delete=models.CASCADE, related_name='swaps_from')
    to_truck       = models.ForeignKey('trucks.Truck', on_delete=models.CASCADE, related_name='swaps_to', null=True, blank=True)
