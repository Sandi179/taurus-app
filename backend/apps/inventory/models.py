...
class StockLedger(TimeStampedModel):
    ...
    location         = models.ForeignKey(Location, on_delete=models.CASCADE, related_name='ledger_entries')
...
class Purchase(TimeStampedModel):
    ...
    supplier    = models.ForeignKey('core.Supplier', on_delete=models.CASCADE, related_name='purchases')
